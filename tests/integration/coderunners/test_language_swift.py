...
class TestSwift:
    def test_hello_world(self):
        ...
        request = SubmissionRequest(test_cases=test_cases, language='swift', code={
            'main.swift': 'print("Hello World!", terminator: "")',
        })
    ...
    def test_mixed_type_output(self):
        ...
        request = SubmissionRequest(test_cases=test_cases, language='swift', code={
            'main.swift': dedent('''
                print("\\(1) \\(2) \\(4) \\(8) \\(16) \\(32) are powers of two", terminator: "")
            ''').strip(),
        }, return_outputs=True)
        res = CodeRunner.from_language(language=request.language).invoke(lambda_client, request=request)
        print(res)
    ...
    def test_compile_error(self):
        request = SubmissionRequest(test_cases=[], language='swift', code={
            'main.swift': dedent('''
