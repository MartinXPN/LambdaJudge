...
The judge supports several languages including `C++`, `Python3`, `C#`, `JavaScript (Node.js)`, `TypeScript`, `R`, `Go`, `Dart`, `Swift`, `PHP`, `Ruby`, `Lua`, `Rust`, `Zig`, `Kotlin`, `Scala`, `Haskell`, `OCaml`.
